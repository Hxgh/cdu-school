...
function ShowNews2(Cid,Num)
  dim rsNews,sqlNews
  set rsNews=server.createobject("adodb.recordset")
  sqlNews="select top "&Num&" * from Article where Cid="&Cid&" order by id desc"
  rsNews.open sqlNews,conn,1,1
  do while not rsNews.eof
	response.write "<li><span>"&rsNews("addtime")&"</span> <a href=""Article.asp?id="&rsNews("id")&""" target=""_blank"">"&left(rsNews("title"),14)&"</a></li>"
  rsNews.movenext
  loop 
  rsNews.close
  set rsNews=nothing
...
function ShowNews3(Cid,Num)
  dim rsNews,sqlNews
  set rsNews=server.createobject("adodb.recordset")
  sqlNews="select top "&Num&" * from Article where Cid="&Cid&" order by id desc"
  rsNews.open sqlNews,conn,1,1
  do while not rsNews.eof
	response.write "<li><a href=""Article.asp?id="&rsNews("id")&""" target=""_blank"">"&left(rsNews("title"),12)&"</a></li>"
  rsNews.movenext
  loop 
  rsNews.close
  set rsNews=nothing
...
'分页显示	
      if intCurPage=1 then 
       response.write "<font size=2px><span>首页 | 上一页 | 第<font color=#ff0000>"&intCurPage&"</font>页 | <a href=""Sort.asp?id="&Cid&"&ToPage="&intCurPage+1&""">下一页</a> | <a href=""Sort.asp?id="&Cid&"&ToPage="&rsSortArticle.PageCount&""">末页</a>"
	  else if intCurPage=rsSortArticle.PageCount then
       response.write "<font size=2px><a href=""Sort.asp?id="&Cid&""">首页</a> | <a href=""Sort.asp?id="&Cid&"&ToPage="&intCurPage-1&""">上一页</a> | 第<font color=#ff0000>"&intCurPage&"</font>页 | 下一页 | 末页"
	  else
	   response.write "<font size=2px><a href=""Sort.asp?id="&Cid&""">首页</a> | <a href=""Sort.asp?id="&Cid&"&ToPage="&intCurPage-1&""">上一页</a> | 第<font color=#ff0000>"&intCurPage&"</font>页 | <a href=""Sort.asp?id="&Cid&"&ToPage="&intCurPage+1&""">下一页</a> | <a href=""Sort.asp?id="&Cid&"&ToPage="&rsSortArticle.PageCount&""">末页</a>"
	  end if
	  end if
       response.write "<font size=2px> | 共 <font color=#ff0000>"&rsSortArticle.PageCount&"</font> 页 <font color=#ff0000>"&proCount&"</font> 条</span>"
    else
	  response.write "<li> 正在更新中... </li>"
    end if
    rsSortArticle.close
